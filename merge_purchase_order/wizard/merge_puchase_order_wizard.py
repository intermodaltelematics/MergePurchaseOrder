...
class MergePurchaseOrder(models.TransientModel):
    ...
    def merge_orders(self):
        ...
        if self.merge_type == "new_cancel":
            self.process_po(
                purchase_orders, partner, create_new_po=True, cancel_po=True
            )
            ...
            self.process_po(purchase_orders, partner, sudo_cancel_rfq=True)

        else:
            self.process_po(purchase_orders, partner, sudo_delete_rfq=True)
